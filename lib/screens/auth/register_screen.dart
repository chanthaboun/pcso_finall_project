...
//             errorMessage = 'ອີເມວນີ້ໄດ້ຖືກລົງທະບຽນແລ້ວ';
//           }
...
// //   // ກວດສອບວ່າອີເມວມີຢູ່ແລ້ວຫຼືບໍ່ (ສຳລັບການກວດສອບແບບ real-time)
// //   Future<void> _checkEmailExists() async {
// //     final email = _emailController.text.trim();
// //     if (email.isNotEmpty && email.contains('@')) {
// //       final existingUser = await SimpleStorageService.findUserByEmail(email);
...
// //                         keyboardType: TextInputType.emailAddress,
// //                         onChanged: (value) {
// //                           // ກວດສອບອີເມວເມື່ອຜູ້ໃຊ້ພິມສຳເລັດ
